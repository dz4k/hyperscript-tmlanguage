...
(async () => {
	...
	const input = path.join(__dirname, './_hyperscript.tmLanguage.yaml')
	const subl  = path.join(__dirname, './_hyperscript.tmLanguage')
	const vsc   = path.join(__dirname, './_hyperscript.tmLanguage.json')
